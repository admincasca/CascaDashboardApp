...
export function FetchInvoices() {
                    ...
                    <table style={{
                        ...
                        <thead>
                            <tr>
                                ...
                                <td class="border_class">Invoice Date</td>
                                <td class="border_class">Invoice No.</td>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                post1.map((item) => (
                                    <tr key={item.invoiceNo}>
                                        ...
                                        <td class="border_class">{item.invoiceDate}</td>
                                        <td class="border_class"><a href={item.downloadURI}>{item.invoiceNo}</a></td>
                                    </tr>
                                ))
                            }
                        </tbody>
    ...
    //let jsonObject = JSON.parse(post);
